...
The optimal revenue calculated in the experiment was 2.0197 (very much in line with the theoretical 2 shown in the paper[ref]). The ratio is evidently ~0.52. Many runs shows that the ratio does indeed hover around 0.5, confirming the proof of the upper bound given in Hartline's book.
...
While no results involving the ERD came close to giving us opportunities to improve the upper bound, we went ahead and explored other pairs of bidders (Not involving ERD) with regular distributions. These bidders had more natural distributions, at least mathematically more prevalent distributions.
